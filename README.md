...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/seqlog-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15092&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/seqlog-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `seqlog` can be installed with:

```
conda install seqlog
```

It is possible to list all of the versions of `seqlog` available on your platform with:
